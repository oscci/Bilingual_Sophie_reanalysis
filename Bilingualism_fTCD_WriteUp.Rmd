...
plotdata <- inner_join(x = L1_Phon_data, L2_Phon_data)
L1_L2_Phon_corr <- cor.test (plotdata$L1_Phon.mean_LI, plotdata$L2_Phon.mean_LI, method = "spearman")

Fig3 <- ggplot(data = plotdata, aes(x = L1_Phon.mean_LI, y = L2_Phon.mean_LI)) + 
  geom_point()+
  theme_bw()+
...
plotdata <- inner_join(x = L1_Sem_data, y = L2_Sem_data)
L1_L2_corr <- cor.test (plotdata$L1_Sem.mean_LI, plotdata$L2_Sem.mean_LI, method = "spearman")

Fig4 <- ggplot(data = plotdata, aes(x = L1_Sem.mean_LI, y = L2_Sem.mean_LI)) +
  geom_point()+
  theme_bw()+
