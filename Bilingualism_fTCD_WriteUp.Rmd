...
Fig7 <- ggplot(data = total_info, aes(x = L2_Acquisition, y = L2.mean_LI)) + 
  geom_point() + 
  theme_bw() + 
...
sd_jwords_phon <- sd(total_info_j$JPhon_words, na.rm = TRUE)
mean_jwords_sem <- mean(total_info_j$JSem_words, na.rm = TRUE)
sd_jwords_sem <- sd(total_info_j$JSem_words, na.rm = TRUE)
mean_ewords_phon <- mean(total_info_j$EPhon_words, na.rm = TRUE)
sd_ewords_phon <- sd(total_info_j$EPhon_words, na.rm = TRUE)
mean_ewords_sem <- mean(total_info_j$ESem_words, na.rm = TRUE)
sd_ewords_sem <- sd(total_info_j$ESem_words, na.rm = TRUE)
