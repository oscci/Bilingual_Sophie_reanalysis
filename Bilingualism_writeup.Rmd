...
```
  ...
  Normalized Doppler velocities for the left and right hemisphere activation are presented for each task in Figure 2. 
...
table2 <- flextable(summary_stats) %>% set_caption(table2, caption='Table 2. Summary statistics for Study 1 laterality indices (N = `r length(which(exclude==0))`)')
...
Fig5a <- dofigure(plotdata=plotdata_Phon,
                 ...
                 colourcol = plotdata_Phon$AoA,
                  pchcol = as.factor(rep(16,nrow(plotdata))),
...
>>>>>>> 7ea149da98eaab88f07387cfb7887f02deaa01b8
